      ...
      body: SingleChildScrollView(
        child: Container(
          ...
          child: Column(
            ...
            children: [    
              CustomListView(MediaQuery.of(context).size.height*0.14),
              CustomListView(MediaQuery.of(context).size.height*0.14),
              CustomListView(MediaQuery.of(context).size.height*0.14),
              CustomListView(MediaQuery.of(context).size.height*0.14),
              CustomListView(MediaQuery.of(context).size.height*0.14),
  ...
  return Container(
    ...
    child: Row(
     ...
     ClipRRect(
        ...
        child: Image.network('https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTmKlRTCFu6fT5nZ9uAOtmy_MPsqse2UNUPvWlQvQ9uqXyR8cY2cv8E73xi1g2gXyelSIM&usqp=CAU',
        fit: BoxFit.fill,
        width: 130,
        height: 210,
        ),
     ...
     Container(
       ...
       child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
         children: [
         Text('Iphone',style: TextStyle(fontSize: 18,fontWeight: FontWeight.bold),), 
          // SizedBox(height: 10,),
          Row(children: [
          ...
          Text('5.0 (23 Reviews)'), 
           ...
           Row(children: [
            Text('20 Pieces'),
             SizedBox(width: 5,),
            Text('Rs 200',style: TextStyle(color: Colors.blue,fontWeight: FontWeight.bold),),
            ],),
            Text('Quantity 1'),
       ],),
     )
