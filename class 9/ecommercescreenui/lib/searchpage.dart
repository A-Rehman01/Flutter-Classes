                        ...
                        child: Row(
                          ...
                          children: [
                           Container(                    
                            ...
                            Image.asset('assets/searchicon.png',width: 30,)
              ],),
                      ),
                      Container(
                        margin: EdgeInsets.only(top: 10),
  ...
  return Container(
    ...
    child: ListTile(
     ...
     leading: CircleAvatar(
       backgroundImage: NetworkImage('https://scontent.fkhi2-3.fna.fbcdn.net/v/t1.6435-9/49454782_1295010970641931_4207202478279622656_n.jpg?_nc_cat=110&ccb=1-3&_nc_sid=09cbfe&_nc_ohc=MR9Ez5jwsHMAX_T8jDV&_nc_ht=scontent.fkhi2-3.fna&oh=e67a95585ea20750dd9395d85bec8b0a&oe=60DF0001'),
       radius: 20,
       ),
